...
(1, 'admin', 'admin@system.com', 'admin123', '2025-04-24 12:34:42');
...
--
-- Table structure for table `dish_grocery_items`
--

CREATE TABLE `dish_grocery_items` (
  `dish_id` int(11) NOT NULL,
...
CREATE TABLE `orders` (
  ...
  `delivery_status` enum('on_time','delayed') DEFAULT 'on_time',
...
--
-- Indexes for table `dish_grocery_items`
--
ALTER TABLE `dish_grocery_items`
...
ALTER TABLE `cart`
  ...
  ADD CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `grocery_items` (`item_id`);

--
-- Constraints for table `dish_grocery_items`
--
ALTER TABLE `dish_grocery_items`
  ADD CONSTRAINT `dish_grocery_items_ibfk_1` FOREIGN KEY (`dish_id`) REFERENCES `dishes` (`dish_id`),
  ADD CONSTRAINT `dish_grocery_items_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `grocery_items` (`item_id`);
